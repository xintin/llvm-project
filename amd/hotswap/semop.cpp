...
#define S(N) case SemOp::N: return #N;
  switch (op) {
    ...
    S(S_LSHL_B32) S(S_LSHL_B64) S(S_LSHR_B32) S(S_ASHR_I32)
    S(S_MUL_I32) S(S_MUL_HI_U32) S(S_MUL_HI_I32) S(S_MUL_U64) S(S_MUL_F32) S(S_ADD_F32)
    ...
    S(V_LSHL_OR_B32) S(V_AND_OR_B32) S(V_OR3_B32)
    ...
    S(DS_READ_B64_TR_B8)
    S(DS_READ_B32) S(DS_READ_B64) S(DS_READ_B128)
    S(DS_READ2_B32) S(DS_READ2_B64)
    S(DS_READ_U16) S(DS_READ_I16) S(DS_READ_U8) S(DS_READ_I8)
    S(DS_WRITE_B32) S(DS_WRITE_B64) S(DS_WRITE_B128)
